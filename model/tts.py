...
class GradTTS(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, n_enc_channels, filter_channels, filter_channels_dp, 
                 ...
                 n_feats, dec_dim, beta_min, beta_max, pe_scale,  a, b, c, d, e, l, p,  n_timesteps, output_dir):
        ...
        self.decoder = Diffusion(n_feats, dec_dim, n_spks, spk_emb_dim, beta_min, beta_max, pe_scale, a, b, c, d, e, l, p, n_timesteps)
